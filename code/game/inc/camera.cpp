...
void Camera::SetDataViewInShader(Shader* shader_ptr, const float width_, const float  height_, const glm::vec3 camera_pos_, const glm::vec2 player_pos)
{
    ...
    glm::mat4 projection = glm::ortho(
        -width_  / 2 + player_pos.x,      // лева€ граница
        width_   / 2 + player_pos.x,      // права€ граница
        -height_ / 2 + player_pos.y,      // нижн€€ граница
        height_  / 2 + player_pos.y,      // верхн€€ граница
        -10.0f, 10.0f                                 // ближн€€ и дальн€€ 
    );
